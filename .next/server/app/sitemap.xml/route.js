...
Don't wait. Contact Water Damage Champ immediately when water damage strikes.
    `,faqs:[{question:"How quickly can you respond to my emergency?",answer:"We typically arrive within 2-4 hours of your call, depending on location and demand. In some areas, we can arrive even faster."},{question:"Are your technicians available 24/7?",answer:"Yes. Our emergency response team is available around the clock, every day of the year, including holidays."},{question:"What should I do while waiting for help?",answer:"Turn off electricity in affected areas if safe, stop the water source if possible, and remove valuables from the affected area."},{question:"Will my insurance cover emergency services?",answer:"Most policies cover sudden, accidental water damage. We work with all major insurance carriers and can verify coverage."},{question:"How much does emergency response cost?",answer:"Emergency response itself is typically covered by insurance. We provide free estimates and work with insurance for seamless claims processing."}]}];function u(){let e="https://waterdamagechamp.com";return[{url:e,lastModified:new Date,priority:1},{url:`${e}/about`,lastModified:new Date,priority:.8},{url:`${e}/contact`,lastModified:new Date,priority:.8},{url:`${e}/locations`,lastModified:new Date,priority:.9},...c.map(a=>({url:`${e}/${a.slug}`,lastModified:new Date,priority:.8})),...d.map(a=>({url:`${e}/locations/${a.slug}`,lastModified:new Date,priority:.7}))]}c.map(e=>e.slug);var m=t(707);let p={...r},g=p.default,f=p.generateSitemaps;if("function"!=typeof g)throw Error('Default export is missing in "C:\\Users\\Clawdbot\\clawd\\water-damage-champ\\src\\app\\sitemap.ts"');async function h(e,a){let t;let{__metadata_id__:r,...n}=a.params||{},s=f?await f():null;if(s&&null==(t=s.find(e=>{let a=e.id.toString();return(a+=".xml")===r})?.id))return new l.NextResponse("Not Found",{status:404});let i=await g({id:t}),o=(0,m.resolveRouteData)(i,"sitemap");return new l.NextResponse(o,{headers:{"Content-Type":"application/xml","Cache-Control":"public, max-age=0, must-revalidate"}})}let y=new s.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/sitemap.xml/route",pathname:"/sitemap.xml",filename:"sitemap",bundlePath:"app/sitemap.xml/route"},resolvedPagePath:"next-metadata-route-loader?page=%2Fsitemap.xml%2Froute&filePath=C%3A%5CUsers%5CClawdbot%5Cclawd%5Cwater-damage-champ%5Csrc%5Capp%5Csitemap.ts&isDynamic=1!?__next_metadata_route__",nextConfigOutput:"export",userland:n}),{requestAsyncStorage:w,staticGenerationAsyncStorage:v,serverHooks:C}=y,W="/sitemap.xml/route";function b(){return(0,o.patchFetch)({serverHooks:C,staticGenerationAsyncStorage:v})}}};var a=require("../../webpack-runtime.js");a.C(e);var t=e=>a(a.s=e),r=a.X(0,[948,346],()=>t(2417));module.exports=r})();