exports.id=242,exports.ids=[242],exports.modules={9291:(e,a,t)=>{Promise.resolve().then(t.t.bind(t,9404,23)),Promise.resolve().then(t.bind(t,398))},398:(e,a,t)=>{"use strict";t.d(a,{default:()=>o});var r=t(326),n=t(7577);function s({question:e,answer:a}){let[t,s]=(0,n.useState)(!1);return(0,r.jsxs)("div",{className:"border border-navy-700 rounded-lg overflow-hidden",children:[(0,r.jsxs)("button",{onClick:()=>s(!t),className:"w-full flex items-center justify-between p-4 text-left bg-navy-800 hover:bg-navy-700 transition-colors",children:[r.jsx("span",{className:"font-semibold",children:e}),r.jsx("svg",{className:`w-5 h-5 text-blue-500 transition-transform ${t?"rotate-180":""}`,fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:r.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M19 9l-7 7-7-7"})})]}),t&&r.jsx("div",{className:"p-4 bg-navy-900 text-gray-300",children:r.jsx("p",{children:a})})]})}function o({faqs:e}){return(0,r.jsxs)("section",{className:"bg-navy-800 rounded-xl p-8",children:[r.jsx("h2",{className:"text-2xl font-bold mb-6",children:"Frequently Asked Questions"}),r.jsx("div",{className:"space-y-4",children:e.map((e,a)=>r.jsx(s,{question:e.question,answer:e.answer},a))})]})}},1392:(e,a,t)=>{"use strict";t.d(a,{Z:()=>r});let r=(0,t(8570).createProxy)(String.raw`C:\Users\Clawdbot\clawd\water-damage-champ\src\components\FAQSection.tsx#default`)},4474:(e,a,t)=>{"use strict";t.d(a,{K:()=>n,c:()=>r});let r=[{name:"Cupertino",state:"CA",slug:"cupertino"},{name:"Sherman Oaks",state:"CA",slug:"sherman-oaks"},{name:"Corona Del Mar",state:"CA",slug:"corona-del-mar"},{name:"Newport Beach",state:"CA",slug:"newport-beach"},{name:"Malibu",state:"CA",slug:"malibu"},{name:"Encino",state:"CA",slug:"encino"},{name:"Woodland Hills",state:"CA",slug:"woodland-hills"},{name:"Pacifica",state:"CA",slug:"pacifica"},{name:"Torrance",state:"CA",slug:"torrance"},{name:"Chula Vista",state:"CA",slug:"chula-vista"},{name:"Milpitas",state:"CA",slug:"milpitas"},{name:"San Mateo",state:"CA",slug:"san-mateo"},{name:"Chino Hills",state:"CA",slug:"chino-hills"},{name:"Los Gatos",state:"CA",slug:"los-gatos"},{name:"Foster City",state:"CA",slug:"foster-city"},{name:"Belvedere Tiburon",state:"CA",slug:"belvedere-tiburon"},{name:"San Rafael",state:"CA",slug:"san-rafael"},{name:"Redondo Beach",state:"CA",slug:"redondo-beach"},{name:"Walnut",state:"CA",slug:"walnut"},{name:"Hawthorne",state:"CA",slug:"hawthorne"},{name:"El Segundo",state:"CA",slug:"el-segundo"},{name:"Corona",state:"CA",slug:"corona"},{name:"Elk Grove",state:"CA",slug:"elk-grove"},{name:"Sausalito",state:"CA",slug:"sausalito"},{name:"San Bernardino",state:"CA",slug:"san-bernardino"},{name:"Ventura",state:"CA",slug:"ventura"},{name:"Stockton",state:"CA",slug:"stockton"},{name:"Palo Alto",state:"CA",slug:"palo-alto"},{name:"National City",state:"CA",slug:"national-city"},{name:"West Hollywood",state:"CA",slug:"west-hollywood"},{name:"Downey",state:"CA",slug:"downey"},{name:"Rancho Cucamonga",state:"CA",slug:"rancho-cucamonga"},{name:"Oxnard",state:"CA",slug:"oxnard"},{name:"Sunnyvale",state:"CA",slug:"sunnyvale"},{name:"Santa Rosa",state:"CA",slug:"santa-rosa"},{name:"Pomona",state:"CA",slug:"pomona"},{name:"Huntington Beach",state:"CA",slug:"huntington-beach"},{name:"Santa Margarita",state:"CA",slug:"santa-margarita"},{name:"Oakland",state:"CA",slug:"oakland"},{name:"San Diego",state:"CA",slug:"san-diego"},{name:"Santa Clara",state:"CA",slug:"santa-clara"},{name:"Victorville",state:"CA",slug:"victorville"},{name:"Burbank",state:"CA",slug:"burbank"},{name:"Richmond",state:"CA",slug:"richmond"},{name:"Calabasas",state:"CA",slug:"calabasas"},{name:"La Jolla",state:"CA",slug:"la-jolla"},{name:"Tampa",state:"FL",slug:"tampa"},{name:"St Petersburg",state:"FL",slug:"st-petersburg"},{name:"Los Angeles",state:"CA",slug:"los-angeles"}],n=r.slice(0,12)},8719:(e,a,t)=>{"use strict";t.d(a,{u:()=>r});let r=[{slug:"water-damage-restoration",name:"Water Damage Restoration",title:"Professional Water Damage Restoration Services",description:"Expert water damage restoration services available 24/7. Fast response, thorough drying, and complete restoration for your property.",fullContent:`
...
Don't let water damage compromise your property's integrity. Contact Water Damage Champ today for immediate assistance.
    `,faqs:[{question:"How long does water damage restoration take?",answer:"The duration varies based on the extent of damage. Minor damage may take 3-5 days, while major flooding can require 2-3 weeks. We provide a timeline after our initial assessment."},{question:"Will my insurance cover water damage restoration?",answer:"Most homeowner insurance policies cover sudden, accidental water damage. We work directly with insurance companies to verify coverage and handle claims paperwork."},{question:"Can I stay in my home during restoration?",answer:"Depends on damage severity. For minor cases, you can typically remain. For extensive damage affecting multiple rooms, we recommend temporary relocation for safety and efficiency."},{question:"What causes most residential water damage?",answer:"Common causes include burst pipes, appliance failures, roof leaks, sewer backups, and natural flooding. Regular maintenance can prevent many of these issues."},{question:"How soon should I call after water damage occurs?",answer:"Immediately. Water damage worsens over time, and mold can begin growing within 24-48 hours. Quick response minimizes damage and restoration costs."}]},{slug:"water-extraction",name:"Water Extraction",title:"Professional Water Extraction Services",description:"Rapid water extraction services to remove standing water and prevent further damage to your property.",fullContent:`
...
Our professional extraction ensures complete removal, proper documentation for insurance, and sets the foundation for effective drying.
    `,faqs:[{question:"How long does water extraction take?",answer:"Extraction time depends on water volume and affected area size. A typical residential job takes 2-4 hours. Larger commercial spaces may require longer."},{question:"Do you extract water from carpet?",answer:"Yes. We extract water from all carpeted areas using specialized equipment. In some cases, carpet removal may be necessary if saturation is extensive."},{question:"Can extraction damage my floors?",answer:"Our trained technicians use appropriate equipment for each floor type. We assess your flooring before extraction to ensure safe, effective water removal."},{question:"What happens after extraction?",answer:"After extraction, we begin the drying process using industrial-grade air movers and dehumidifiers to eliminate remaining moisture."},{question:"Is extraction covered by insurance?",answer:"Water extraction is typically covered under most homeowner insurance policies when the damage is sudden and accidental. We help verify your coverage."}]},{slug:"flood-damage-repair",name:"Flood Damage Repair",title:"Professional Flood Damage Repair Services",description:"Complete flood damage repair and restoration services to restore your property after flooding events.",fullContent:`
...
We work directly with flood insurance carriers, documenting all damage with photographs and detailed reports. Our team understands NFIP (National Flood Insurance Program) requirements and helps streamline your claim.
    `,faqs:[{question:"How much does flood damage repair cost?",answer:"Costs vary based on water depth, affected area size, and contamination level. We provide free estimates and work with insurance when applicable."},{question:"Can flood-damaged furniture be saved?",answer:"Many items can be restored with professional cleaning and treatment. We assess each item individually and discuss restoration options with you."},{question:"What should I do immediately after flooding?",answer:"Ensure safety first, then contact us for emergency extraction. Avoid entering flood-damaged areas until assessed for electrical and structural hazards."},{question:"How long does flood damage repair take?",answer:"Minor flood damage may require 1-2 weeks. Major flooding can take several weeks to months, depending on structural damage extent."},{question:"Does flood insurance cover your services?",answer:"We work with all standard flood insurance policies. Our team handles documentation and insurance coordination for seamless claims processing."}]},{slug:"mold-remediation",name:"Mold Remediation",title:"Professional Mold Remediation Services",description:"Expert mold removal and remediation services to eliminate mold and protect your family's health.",fullContent:`
...
Our mold remediation technicians hold industry certifications and follow EPA and IICRC guidelines. We use professional-grade protective equipment and follow strict safety protocols.
    `,faqs:[{question:"How long does mold remediation take?",answer:"Duration depends on the extent of mold growth. Small areas may be remediated in 1-2 days. Large-scale contamination can take 1-2 weeks."},{question:"Is mold dangerous to my health?",answer:"Mold can cause allergic reactions, respiratory problems, and other health issues. Some molds produce mycotoxins that pose serious health risks."},{question:"Can I remove mold myself?",answer:"Small mold areas (less than 10 square feet) may be handled DIY with proper safety equipment. Larger areas require professional remediation."},{question:"Will mold come back after remediation?",answer:"If moisture sources are eliminated and proper prevention measures are applied, mold should not return. We address root causes to prevent recurrence."},{question:"How much does mold remediation cost?",answer:"Costs depend on affected area size and contamination severity. We provide free inspections and estimates."}]},{slug:"storm-damage-restoration",name:"Storm Damage Restoration",title:"Professional Storm Damage Restoration",description:"Complete storm damage restoration services to repair and restore your property after severe weather events.",fullContent:`
...
Storm damage claims require thorough documentation. Our team works directly with insurance adjusters, providing detailed damage assessments and coordinating repairs.
    `,faqs:[{question:"What should I do immediately after storm damage?",answer:"Ensure safety first, then contact us for emergency board-up and tarping. Document damage with photos if safe to do so before insurance inspection."},{question:"Does insurance cover storm damage?",answer:"Most standard homeowner policies cover storm damage, including wind, hail, and rain damage. Flood damage typically requires separate flood insurance."},{question:"How long does storm damage restoration take?",answer:"Duration depends on damage extent. Minor damage may take 1-2 weeks. Major storm damage requiring structural repairs can take months."},{question:"Can I stay in my home during restoration?",answer:"Depends on damage severity. We assess each situation and recommend whether temporary relocation is necessary for safety."},{question:"Do you work with insurance adjusters?",answer:"Yes. We coordinate directly with insurance adjusters, providing detailed documentation and estimates to streamline your claim."}]},{slug:"sump-pump-cleanup",name:"Sump Pump Cleanup",title:"Professional Sump Pump Cleanup Services",description:"Expert cleanup services after sump pump failures, flooding, and water intrusion in basements and crawl spaces.",fullContent:`
...
Don't wait for the next storm. Contact us today to inspect your sump pump system and prevent future failures.
    `,faqs:[{question:"How often should I test my sump pump?",answer:"Test your sump pump at least twice yearly, ideally before heavy rain seasons. Check the float mechanism, discharge line, and backup systems."},{question:"What is the average lifespan of a sump pump?",answer:"Sump pumps typically last 7-10 years with proper maintenance. Regular testing and maintenance can extend lifespan."},{question:"Are battery backup sump pumps worth it?",answer:"Yes. Battery backups provide protection during power outages when sump pumps are most needed. They're especially valuable in areas with frequent storms."},{question:"How much does sump pump cleanup cost?",answer:"Costs depend on water volume and affected area size. We provide free estimates for all cleanup services."},{question:"Can I prevent sump pump failures?",answer:"Regular maintenance, testing, and installing backup systems significantly reduce failure risk. We offer maintenance plans and upgrade services."}]},{slug:"ceiling-wall-water-damage",name:"Ceiling and Wall Water Damage",title:"Ceiling and Wall Water Damage Repair",description:"Professional repair services for water-damaged ceilings, walls, and drywall throughout your property.",fullContent:`
...
If you notice these signs, contact us immediately for professional assessment.
    `,faqs:[{question:"How do you match existing wall textures?",answer:"Our craftsmen assess your existing texture (orange peel, knockdown, smooth, etc.) and use specialized techniques to match it precisely."},{question:"Can damaged drywall be repaired or does it need replacement?",answer:"Minor damage can be patched. Extensive damage, sagging, or mold contamination typically requires full panel replacement."},{question:"How long does wall and ceiling repair take?",answer:"Small repairs take 1-2 days. Large-scale repairs involving multiple rooms may take 1-2 weeks."},{question:"Will my paint match exactly?",answer:"We color-match using your existing paint or provide matching paint. Perfect matches depend on original paint age and sun exposure."},{question:"Do you handle the entire repair including painting?",answer:"Yes. We provide complete restoration from removal through final painting and finishing."}]},{slug:"crawlspace-encapsulation",name:"Crawlspace Encapsulation",title:"Crawlspace Encapsulation Services",description:"Professional crawlspace encapsulation to prevent moisture, mold, and structural damage in your home.",fullContent:`
...
Traditional building codes called for ventilated crawlspaces, but modern understanding favors encapsulation in most cases. We assess your specific situation and recommend the optimal approach.
    `,faqs:[{question:"How long does crawlspace encapsulation take?",answer:"Most residential encapsulation projects complete in 2-5 days, depending on crawlspace size and condition."},{question:"Do I need to encapsulate if my crawlspace has vents?",answer:"We assess your specific situation. In many cases, sealing vents and encapsulating is more effective than traditional ventilation."},{question:"Will encapsulation eliminate all moisture?",answer:"Proper encapsulation significantly reduces moisture, but very humid climates may require supplemental dehumidification."},{question:"How much does crawlspace encapsulation cost?",answer:"Costs vary based on crawlspace size and condition. We provide free estimates for all encapsulation projects."},{question:"Does encapsulation add value to my home?",answer:"Yes. Encapsulation improves air quality, energy efficiency, and structural protection, all valued by home buyers."}]},{slug:"commercial-water-damage",name:"Commercial Water Damage",title:"Commercial Water Damage Restoration",description:"Professional water damage restoration services for businesses, warehouses, offices, and commercial properties.",fullContent:`
...
- Managing content storage
    `,faqs:[{question:"Can you work outside business hours?",answer:"Yes. We coordinate with you to schedule work that minimizes disruption to your operations and customers."},{question:"Do you handle large-scale commercial jobs?",answer:"Yes. Our team has experience with industrial-scale water damage, including warehouses, manufacturing facilities, and large office buildings."},{question:"How do you handle inventory and equipment?",answer:"We carefully pack, catalog, and store affected items. We can coordinate with specialized content restoration services as needed."},{question:"Do you provide documentation for insurance claims?",answer:"Yes. We provide comprehensive documentation including photographs, detailed reports, and itemized estimates for insurance purposes."},{question:"How quickly can you respond to commercial emergencies?",answer:"We prioritize commercial accounts and can typically respond within hours to minimize business interruption."}]},{slug:"emergency-water-damage",name:"Emergency Water Damage",title:"24/7 Emergency Water Damage Response",description:"24/7 emergency water damage restoration services. Fast response when you need it most.",fullContent:`
...
Don't wait. Contact Water Damage Champ immediately when water damage strikes.
    `,faqs:[{question:"How quickly can you respond to my emergency?",answer:"We typically arrive within 2-4 hours of your call, depending on location and demand. In some areas, we can arrive even faster."},{question:"Are your technicians available 24/7?",answer:"Yes. Our emergency response team is available around the clock, every day of the year, including holidays."},{question:"What should I do while waiting for help?",answer:"Turn off electricity in affected areas if safe, stop the water source if possible, and remove valuables from the affected area."},{question:"Will my insurance cover emergency services?",answer:"Most policies cover sudden, accidental water damage. We work with all major insurance carriers and can verify coverage."},{question:"How much does emergency response cost?",answer:"Emergency response itself is typically covered by insurance. We provide free estimates and work with insurance for seamless claims processing."}]}];r.map(e=>e.slug)},7327:(e,a,t)=>{"use strict";function r(e){let a={"@context":"https://schema.org","@type":"LocalBusiness",name:"Water Damage Champ",telephone:"+1-888-510-9436",priceRange:"$$",openingHours:"Mo-Su 00:00-24:00",url:"https://waterdamagechamp.com",description:"Professional water damage restoration services available 24/7."};return e?{...a,address:{"@type":"PostalAddress",addressLocality:e.name,addressRegion:e.state,addressCountry:"US"},areaServed:{"@type":"City",name:`${e.name}, ${e.state}`},name:`Water Damage Champ - ${e.name}`,url:`https://waterdamagechamp.com/locations/${e.slug}`}:a}function n(e){return{"@context":"https://schema.org","@type":"Service",name:e.name,description:e.description,provider:{"@type":"LocalBusiness",name:"Water Damage Champ",telephone:"+1-888-510-9436"},areaServed:"CA, FL",url:`https://waterdamagechamp.com/${e.slug}`}}function s(e,a){return{"@context":"https://schema.org","@type":"FAQPage",mainEntity:a.map(e=>({"@type":"Question",name:e.question,acceptedAnswer:{"@type":"Answer",text:e.answer}}))}}function o(e){return{"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:e.map((e,a)=>({"@type":"ListItem",position:a+1,name:e.name,item:e.url}))}}t.d(a,{Al:()=>s,KZ:()=>n,Yo:()=>r,iR:()=>o})}};